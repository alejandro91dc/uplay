...
if ($resultado->num_rows > 0) {
    ...
    // Maneja el caso donde no se encontró ninguna serie con ese ID
    echo "No se encontró ninguna serie con el ID proporcionado.";
}
...
<div id="individualContainer">
    <div id="individualContent">
        ...
        <p>Temporadas: <?php echo $Temporadas; ?></p>
        <p>Categoría:  <a href="series.php?cat=<?php echo $categoria; ?>"><?php echo $categoria; ?></a></p>
